...
const skills = [
    {
        title: 'Front-end',
        tags: ['Animations', 'Requêtes API', 'Javascript', 'jQuery', 'React', 'Redux', 'Responsive design', 'Sass', 'Templating : TWIG, EJS', 'React Testing Library', 'Three.js', 'Typescript', 'WebVR : A-Frame'],
        icon: Front,
