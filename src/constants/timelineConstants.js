...
const education = [
    {key: '2014', icon: {src: "", alt: ""}, title: "", datePlace: [], description: [], size: '1'},
    {
        key: '2014',
    ...
    {key: '2020', icon: {src: "", alt: ""}, title: "", datePlace: [], description: [], size: '1'},
    {
        key: '2021',
    ...
    {key: '2021', icon: {src: "", alt: ""}, title: "", datePlace: [], description: [], size: '5'}
]

const experience = [
    {key: '2014', icon: {src: "", alt: ""}, title: "", datePlace: [], description: [], size: '3'},
    {
        key: '2015',
        icon: {src: "", alt: ""},
